...
pred prop3 {
// Trains never move
always all t: Train | {let x = t.pos | Train}


pred prop3C { // Trains never move
	always pos' = pos
}
pred overconstrained { prop3C and !prop3}
pred underconstrained { !prop3C and prop3}
pred both { prop3C and prop3 }
