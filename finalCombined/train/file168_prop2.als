...
pred prop2C {// Every signal will eventually become green
	all s : Signal | eventually s in Green
}
pred overconstrained { prop2C and !prop2}
pred underconstrained { !prop2C and prop2}
pred both { prop2C and prop2 }
